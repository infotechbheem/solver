                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-md-5 grapgh-content">
                                    <ul>
                                        ...
                                        <li><span style="color:#FFCD56;">●</span> Ranchi 20%</li>
...
<script>
    ...
    const labels = [
        ...
        'Governance Training', 'Financila Management',
        'Financial Inclusion', 'Row Material'
    ];

    const dataValues = [153, 133, 129, 127, 115, 99, 94, 49, 38, 67];
