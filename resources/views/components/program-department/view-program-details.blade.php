 <div class="employee-card">
    ...
    <div class="employee-body">
        <table class="employee-table">
            ...
            <tr>
                <td>{{ $programDetails->donar_organisation }}</td>
                <td>{{ $programDetails->project }}</td>
                <td>{{ $programDetails->support_partner }}</td>
            </tr>
            <tr>
            ...
            <tbody id="socialProtect" style="display: none;">
                ...
                <tr>
                    <td>{{ $yesNoOptions[$social->differently_abled] ?? ucfirst($social->differently_abled) }}</td>
                    <td>{{ $documentOptions[$social->applied_document] ?? ucfirst(str_replace('_', ' ', $social->applied_document)) }}</td>
                    <td>{{ $schemeOptions[$social->applied_scheme] ?? ucfirst(str_replace('_', ' ', $social->applied_scheme)) }}</td>
                </tr>
                @endforeach
            </tbody>
            ...
            <tbody id="livelihoodBeneficiary" style="display: none;">
                ...
                <tr>
                    <td>{{ $yesNoOptions[$livelihood->differently_abled] ?? ucfirst($livelihood->differently_abled) }}</td>
                    <td>{{ $supportOptions[$livelihood->support] ?? ucfirst(str_replace('_', ' ', $livelihood->support)) }}</td>
            ...
            <tbody id="communityCapacity" style="display: none;">
                @foreach ($programDetails->communities as $community)
                    ...
                    <tr>
                        <td>{{ $yesNoOptions[$community->differently_abled] ?? ucfirst($community->differently_abled) }}</td>
                        <td>{{ $areaOptions[$community->area] ?? ucfirst(str_replace('_', ' ', $community->area)) }}</td>
                        <td>{{ $project[$community->project] ?? ucfirst(str_replace('_', ' ', $community->project)) }}</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>{{ $organisation_type[$community->org_type] ?? ucfirst(str_replace('_', ' ', $community->org_type)) }}</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td>{{ $working_period[$community->working_period] ?? ucfirst($community->working_period) }}</td>
                        <td>{{ $members[$community->no_of_members] ?? ucfirst(str_replace('_', ' ', $community->no_of_members)) }}</td>
                        <td>{{ $org_focus_working_area[$community->org_focused_working_area] ?? ucfirst($community->org_focused_working_area) }}</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td>{{ $org_support[$community->support] ?? ucfirst(str_replace('_', ' ', $community->support)) }}</td>
                        <td>{{ $communitySupport[$community->community_support] ?? ucfirst(str_replace('_', ' ', $community->community_support)) }}</td>
            ...
            <tbody id="digitalLiteracy" style="display: none;">
                ...
                <tr>
                    <td>{{ $yesNoOptions[$digital->differently_abled] ?? ucfirst($digital->differently_abled) }}</td>
                    <td>{{ $areaOptions[$digital->area] ?? ucfirst(str_replace('_', ' ', $digital->area)) }}</td>
                    <td>{{ $sessionsWeCOnduct[$digital->type_of_sessions] ?? ucfirst(str_replace('_',' ', $digital->type_of_sessions)) }}</td>
                </tr>
                @endforeach
            </tbody>
